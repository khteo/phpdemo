...
$(document).ready(function() {       
    ...
    var popdensityJSON = new L.GeoJSON.AJAX("data/popdensity.json", {
    ...
    function populateDemographics() {
        $.getJSON("data/popdensity.json", function(data) {
    ...
    $("#control-mrt-map").click(function() {
        if (document.getElementById("control-mrt-map").checked == true) {
            ...
            feature_group.removeLayer(MRTlinesallJSON);
            feature_group.removeLayer(MRTpointsJSON);
        }
    });
